...
const QuizScreen = ({ quizType = "multiple", subType = "meaning" }) => {
...
const generateQuestion = async () => {
  ...
  const distractors = await getConfusingWords(word, selectedType, vocabularyList);
  ...
  const recordAnswer = (isCorrect, questionType) => {
